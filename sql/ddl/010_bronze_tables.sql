CREATE TABLE IF NOT EXISTS airline_ops.bronze.flight_operations_raw (
    flight_date DATE,
...
CREATE TABLE IF NOT EXISTS airline_ops.bronze.airports_raw (
    airport_id STRING,
    ident STRING,
    type STRING,
    name STRING,
...
CREATE TABLE IF NOT EXISTS airline_ops.bronze.aircraft_reference_raw (
...
CREATE TABLE IF NOT EXISTS airline_ops.bronze.weather_metar_raw (
    station_id STRING,
