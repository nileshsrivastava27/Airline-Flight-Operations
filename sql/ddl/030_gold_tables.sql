CREATE TABLE IF NOT EXISTS airline_ops.gold.on_time_performance_daily (
    flight_date DATE,
...
CREATE TABLE IF NOT EXISTS airline_ops.gold.route_delay_summary (
    flight_date DATE,
    route_code STRING,
...
CREATE TABLE IF NOT EXISTS airline_ops.gold.airport_delay_summary (
    flight_date DATE,
    airport_code STRING,
    airport_role STRING,
    reporting_airline STRING,
...
CREATE TABLE IF NOT EXISTS airline_ops.gold.cancellation_summary (
    flight_date DATE,
    reporting_airline STRING,
    origin_airport STRING,
    dest_airport STRING,
...
CREATE TABLE IF NOT EXISTS airline_ops.gold.aircraft_performance_summary (
    flight_date DATE,
    tail_number STRING,
