CREATE TABLE IF NOT EXISTS airline_ops.silver.airports_clean (
...
CREATE TABLE IF NOT EXISTS airline_ops.silver.aircraft_reference_clean (
...
CREATE TABLE IF NOT EXISTS airline_ops.silver.route_reference (
...
CREATE TABLE IF NOT EXISTS airline_ops.silver.weather_observations_clean (
...
CREATE TABLE IF NOT EXISTS airline_ops.silver.flight_operations_clean (
...
CREATE TABLE IF NOT EXISTS airline_ops.silver.flight_operations_quarantine (
