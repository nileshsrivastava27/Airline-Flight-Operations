"""
Notebook-friendly Silver transformation helper for Databricks.

This module transforms Bronze Delta tables into cleaned Silver Delta tables for
...
class SilverTransformationJob:
    ...
    def run_all(self) -> list[dict[str, Any]]:
        ...
        results = [
            ...
            self._write_dataframe(
                aircraft_df,
                SilverWriteSpec(
                    target_table="airline_ops.silver.aircraft_reference_clean",
            ...
            self._write_dataframe(
                weather_df,
                SilverWriteSpec(
                    target_table="airline_ops.silver.weather_observations_clean",
            ...
            self._write_dataframe(
                valid_flights_df,
                SilverWriteSpec(
                    target_table="airline_ops.silver.flight_operations_clean",
            ...
            self._write_dataframe(
                quarantine_df,
                SilverWriteSpec(
                    target_table="airline_ops.silver.flight_operations_quarantine",
            ...
            self._write_dataframe(
                route_df,
                SilverWriteSpec(
                    target_table="airline_ops.silver.route_reference",
    ...
    def transform_airports(self) -> DataFrame:
        ...
        bronze_df = self.spark.table("airline_ops.bronze.airports_raw")
        return (
            bronze_df.filter(
    ...
    def transform_aircraft_reference(self) -> DataFrame:
        ...
        bronze_df = self.spark.table("airline_ops.bronze.aircraft_reference_raw")
        return (
    ...
    def transform_weather_observations(self) -> DataFrame:
        ...
        bronze_df = self.spark.table("airline_ops.bronze.weather_metar_raw")
        return (
    ...
    def transform_flight_operations(self) -> tuple[DataFrame, DataFrame]:
        ...
        bronze_df = self.spark.table("airline_ops.bronze.flight_operations_raw")
